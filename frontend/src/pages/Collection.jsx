import React, { useContext, useState, useEffect, use } from 'react'; // Fixed import
...
let fyCopy = filterProducts.slice();


switch (sortType){

  case 'low-high':
    setFilterProducts(fyCopy.sort((a, b) => (a.price - b.price)));
    break;
  case 'high-low':  
    setFilterProducts(fyCopy.sort((a, b) => (b.price - a.price)));
    break;
  default:
    applyFilter();
    break;
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        <p onClick={() => setShowFilter(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2'> {/* Fixed typo */}
          FILTERS
